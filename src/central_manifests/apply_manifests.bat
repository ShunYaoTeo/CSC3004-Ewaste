...
call :applyManifests gateway_manifests
call :applyManifests auth_manifests
call :applyManifests ewaste_manifests
call :applyManifests rewards_manifests
